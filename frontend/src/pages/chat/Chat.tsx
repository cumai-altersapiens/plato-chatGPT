                        ...
                        {!messages || messages.length < 1 ? (
                            <Stack className={styles.chatEmptyState}>
                                <img
                                    ...
                                    aria-hidden="true"
                                />
                                <h1 className={styles.chatEmptyStateTitle}>Start a new dialogue</h1>
                                <h2 className={styles.chatEmptyStateSubtitle}>Welcome to a virtual agora, where you can converse with the AI resurrection of Plato the philosopher.</h2>
                            </Stack>
                        ) : (
